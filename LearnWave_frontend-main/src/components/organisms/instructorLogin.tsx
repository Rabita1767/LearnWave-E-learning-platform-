...
const InstructorLogin: React.FC = () => {
    ...
    const handleLogin = (data: any) => {
        const fetchData = async () => {
            ...
            try {
                const response = await instructorService.fetchLogin(data);
                ...
                <div className="flex">
                    ...
                    <div className="w-1/2 p-8">
                        ...
                        <div className="mt-[80px] ml-[210px]">
                            ...
                            <div className="px-[10px] pt-[20px]"><p className="text-[20px]"><Link to="/instructorSignup">Dont have an Account?Sign Up</Link></p></div>
                        </div>
                    </div>
                </div >
            )}
